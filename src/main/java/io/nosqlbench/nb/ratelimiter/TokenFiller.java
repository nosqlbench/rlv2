...
public class TokenFiller implements Runnable {
     ...
     *
     */
    public TokenFiller(final RateSpec rateSpec, final ThreadDrivenTokenPool tokenPool,
            final Map<String, String> labeled, final int hdrdigits) {
    ...
    public void run() {
        ...
        while (this.running) {
            ...
            while (thisRefillTime < nextRefillTime) {
                ...
                // System.out.println(ANSI_Blue + " parking for " + parkfor + "ns" +
                // ANSI_Reset); System.out.flush();
                LockSupport.parkNanos(parkfor);
                // System.out.println(ANSI_Blue + "unparking for " + parkfor + "ns" +
                // ANSI_Reset); System.out.flush();
    ...
    public String toString() {
        return "TokenFiller spec=" + this.rateSpec + " interval=" + interval + "ns pool:" + this.tokenPool + " running="
                + this.running;
    }
