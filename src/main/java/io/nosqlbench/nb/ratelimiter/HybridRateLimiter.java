...
public class HybridRateLimiter implements RateLimiter {
    ...
    protected void init(final Map<String, String> activityDef) {
        // delayGauge = ActivityMetrics.gauge(activityDef, this.label + ".waittime", new
        // WaitTimeGauge(this));
        // avgRateGauge = ActivityMetrics.gauge(activityDef, this.label +
        // ".config.cyclerate", new RateGauge(this));
        // burstRateGauge = ActivityMetrics.gauge(activityDef, this.label +
        // ".config.burstrate", new BurstRateGauge(this));
    }
