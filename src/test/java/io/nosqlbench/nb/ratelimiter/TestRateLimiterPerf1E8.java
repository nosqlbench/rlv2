...
/**
 * These tests are for sanity checking rate limiter implementations. They are
 * not enabled by default,
 * since they are very CPU an time intensive. If you are developing rate
 * limiters, use these to understand
...
public class TestRateLimiterPerf1E8 {
    ...
    private final Function<RateSpec, RateLimiter> rlFunction = rs -> new HybridRateLimiter(
 ...
 //   @Disabled
    ...
    public void test100Mops_80threads() {
        final Perf perf = this.methods.testRateLimiterMultiThreadedContention(this.rlFunction, new RateSpec(1.0E8, 1.1),
                100_000_000, 80);
        System.out.println(perf.getLastResult());
    }
    ...
    public static void main(String[] args) {
        new TestRateLimiterPerf1E8().test100Mops_4000threads();
    }
